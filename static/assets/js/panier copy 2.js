...
*/
        ...
        .then(response => {
          if (response.ok) {
            ...
            return Promise.reject('Erreur 400: Bad Request');
          } else if (response.status === 401) {
            return Promise.reject('Erreur 401: Unauthorized');
          } else if (response.status === 404) {
            return Promise.reject('Le repas n\'existe pas ou est en rupture de stock');
          } else {
